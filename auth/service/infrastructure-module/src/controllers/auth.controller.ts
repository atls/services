import type { ConfirmLoginCodeRequest }         from '@atls/auth-rpc/interfaces'
import type { ConfirmLoginCodeResponse }        from '@atls/auth-rpc/interfaces'
import type { ConfirmRecoveryCodeRequest }      from '@atls/auth-rpc/interfaces'
import type { ConfirmRecoveryCodeResponse }     from '@atls/auth-rpc/interfaces'
import type { ConfirmVerificationCodeRequest }  from '@atls/auth-rpc/interfaces'
import type { ConfirmVerificationCodeResponse } from '@atls/auth-rpc/interfaces'
import type { DeleteUserAccountRequest }        from '@atls/auth-rpc/interfaces'
import type { DeleteUserAccountResponse }       from '@atls/auth-rpc/interfaces'
import type { GetUserAccountRequest }           from '@atls/auth-rpc/interfaces'
import type { GetUserAccountResponse }          from '@atls/auth-rpc/interfaces'
import type { LoginUserByEmailRequest }         from '@atls/auth-rpc/interfaces'
import type { LoginUserByEmailResponse }        from '@atls/auth-rpc/interfaces'
import type { LoginUserByPhoneRequest }         from '@atls/auth-rpc/interfaces'
import type { LoginUserByPhoneResponse }        from '@atls/auth-rpc/interfaces'
import type { RegisterUserByEmailRequest }      from '@atls/auth-rpc/interfaces'
import type { RegisterUserByEmailResponse }     from '@atls/auth-rpc/interfaces'
import type { RegisterUserByPhoneRequest }      from '@atls/auth-rpc/interfaces'
import type { RegisterUserByPhoneResponse }     from '@atls/auth-rpc/interfaces'
import type { LoginUserByProviderRequest }      from '@atls/auth-rpc/interfaces'
import type { LoginUserByProviderResponse }     from '@atls/auth-rpc/interfaces'
import type { SendRecoveryCodeRequest }         from '@atls/auth-rpc/interfaces'
import type { SendRecoveryCodeResponse }        from '@atls/auth-rpc/interfaces'
import type { SendVerificationCodeRequest }     from '@atls/auth-rpc/interfaces'
import type { SendVerificationCodeResponse }    from '@atls/auth-rpc/interfaces'
import type { UpdateUserEmailRequest }          from '@atls/auth-rpc/interfaces'
import type { UpdateUserEmailResponse }         from '@atls/auth-rpc/interfaces'
import type { UpdateUserPasswordRequest }       from '@atls/auth-rpc/interfaces'
import type { UpdateUserPasswordResponse }      from '@atls/auth-rpc/interfaces'
...
import { ProviderType as RpcProviderType }      from '@atls/auth-rpc/abstractions'
import { AuthService }                          from '@atls/auth-rpc/connect'
import { ProviderType }                         from '@atls/auth-rpc/interfaces'
